...
def compute_metrics(preds, labels):
    return {'Acc': (preds == labels).mean(), 'F1': f1_score(y_true=labels, y_pred=preds)}
...
if __name__ == '__main__':
    main(data_dir="data/hotel",
         model_dir="model/teacher.pth",
         bert_model="/data0/sina_up/dajun1/src/doc_dssm/sentence_bert/bert_pytorch"
         )
